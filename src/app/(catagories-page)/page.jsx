            ...
            <GenrePageComponent pageTitle="Homepage">
                <main className="w-[60%] h-[580px] flex justify-between items-center mx-auto ">
                    {genre?.map((genre) => (
                        ...
                        >
                            <Image src={genre.img} fill alt={genre.title} className="transition-all duration-300"/>

                            <span
                                className="bg-white/90 px-2 py-1 absolute top-3 left-2 rounded-2xl flex items-center gap-2 text-custom-blue shadow z-20"
                            >
